  ...
  return (
    <main className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 flex flex-col gap-6 md:gap-8 justify-center items-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* Modern Subheadline */}
        <p className="max-w-2xl text-lg md:text-xl text-center text-gray-600 leading-relaxed">
          Everything you need to crack competitive exams. 
          <span className="text-gray-900 font-medium"> Mock tests, PYQs, notes</span> all in one intelligent platform.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
          <Link 
            href="/login" 
            className="group relative inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white transition-all duration-200 bg-gray-900 rounded-full hover:bg-gray-800 hover:shadow-lg hover:shadow-gray-900/25 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
          >
            Start Free Trial
